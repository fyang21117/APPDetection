package com.fyang.appdetection.engine;
...
public class AddressDao {
    ...
    //1,指定访问数据库的路径
    public static String path = "data/data/com.fj.mobilesafe/files/address.db";
    ...
    public static String getAddress(String phone) {
        ...
        if (phone.matches(regularExpression)) {
            ...
            //3,数据库查询
            Cursor cursor = sqLiteDatabase.query("data1",
                    new String[]{"outkey"},
                    "id = ?",
                    new String[]{phone},
                    null, null, null);
            ...
            if (cursor.moveToNext()) {
                ...
                Cursor indexCursor = sqLiteDatabase.query("data2", new String[]{"location"}, "id = ?", new String[]{outkey}, null, null, null);
            ...
            switch (length) {
                ...
                case 11:
                    ...
                    Cursor cursor = sqLiteDatabase.query("data2", new String[]{"location"}, "area = ?", new String[]{area}, null, null, null);
                    if (cursor.moveToNext()) {
                ...
                case 12:
                    ...
                    Cursor cursor1 = sqLiteDatabase.query("data2", new String[]{"location"}, "area = ?", new String[]{area1}, null, null, null);
